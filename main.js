...
myCodeImmersivesObj.objectify = 'Dallas'
...
dallas.address.push('123', 'hillRoad', 'ca')
...
const obj = function(key) {
  birthday[key] = 'overwritten DYNAMICALLY!'
}
obj('Month');
birthday;